...
export default function Section4() {
  return (
    <div>
      <div className="section4 section4_phnview">
        ...
        <div className="section4_box1">
          <div className="section4_box1-info">
            ...
            <p className="section4_box1-para">
              ...
              nonummy nibh euismod tincidunt ut laoreet dolore magna autem vel
              eum iriure dolor in hendrerit in vulputate velit esse molestie
              consequat, vel illum dolore eu feugiat nulla facilisis at vero
              eros et ac Lorem ipsum dolor sit amet, consectetuer adipiscing
              elit, diam nonummy nibh euismod tincidunt ut
            </p>
          </div>
        </div>
        <br />
